"""
CircleID — Pen Classification v6a (ABLATION: rotation=0 only)
v5 baseline + rotation removed. Everything else identical to v5.
...
class PenConfig:
    ...
    output_dir: Path = BASE_DIR / "outputs_v6a"
    checkpoint_dir: Path = BASE_DIR / "checkpoints_v6a"
...
if __name__ == "__main__":
    ...
    print(f"\n{'=' * 70}")
    print(f"CircleID Pen v6a — v5+NoRotation — {cfg.n_folds}-Fold")
    print(f"{'=' * 70}")
    ...
    out_path = Path(cfg.output_dir) / "submission_pen_v6a.csv"
